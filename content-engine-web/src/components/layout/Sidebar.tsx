...
export function Sidebar() {
  ...
  return (
    ...
    >
      {/* Avatar / Profil en haut → Connexion */}
      <Link
        href="/login"
        className="mb-6 flex h-10 w-10 items-center justify-center rounded-full bg-[var(--border-subtle)] text-sm text-[var(--text-muted)] hover:bg-[var(--elevated-hover)] hover:text-[var(--text-primary)]"
        title="Connexion"
      >
        U
      </Link>
